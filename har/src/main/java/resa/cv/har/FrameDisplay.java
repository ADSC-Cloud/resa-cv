 ...
 */
public class FrameDisplay extends BaseRichBolt implements Constants {
    OutputCollector collector;

    private HashMap<Integer, Protocal.Mat> rawFrameMap;
    ...
    public FrameDisplay(String traceAggBoltNameString) {
