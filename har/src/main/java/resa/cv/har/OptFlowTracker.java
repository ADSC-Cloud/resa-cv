...
public class OptFlowTracker extends BaseRichBolt implements Constants {
    ...
    public OptFlowTracker(String traceAggBoltNameString) {
    ...
    public void processTraceRecords(int frameId) {
        ...
        while (!traceRecords.isEmpty()) {
            ...
            //CvPoint2D32f pointOut = getNextFlowPoint(flow, trace.lastPoint);
            Protocal.CvPoint2D32f pointOut = getNextFlowPointSimple(floatArray, whInfo, trace.lastPoint);
    ...
    public Protocal.CvPoint2D32f getNextFlowPoint(IplImage flow, Protocal.CvPoint2D32f point_in) {
        ...
        Protocal.CvPoint2D32f offset = new Protocal.CvPoint2D32f();
        offset.x(xs.getLast());
        offset.y(ys.getLast());

        Protocal.CvPoint2D32f point_out = new Protocal.CvPoint2D32f();
    ...
    public Protocal.CvPoint2D32f getNextFlowPointSimple(IplImage flow, Protocal.CvPoint2D32f point_in) {
    ...
    public Protocal.CvPoint2D32f getNextFlowPointSimple(List<float[]> floatArray, TwoIntegers whInfo,
                                                            Protocal.CvPoint2D32f point_in) {
